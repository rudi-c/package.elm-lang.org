...
Elm.Searchbox.make = function (_elm) {
   ...
   if (_elm.Searchbox.values)
   return _elm.Searchbox.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var searchbox = $Signal.channel("");
   var searchSignal = $Signal.subscribe(searchbox);
   var initialState = {_: {}
                      ,query: ""
                      ,results: $Maybe.Nothing};
   var SearchState = F2(function (a,
   b) {
      return {_: {}
             ,query: a
             ,results: b};
   });
   var responseDecoder = function () {
      var rangeDecoder = A2($Json$Decode.map,
      function (range) {
         return {ctor: "_Tuple2"
                ,_0: $List.head(range)
                ,_1: $List.head($List.tail(range))};
      },
      $Json$Decode.list($Json$Decode.$int));
      var rangesDecoder = $Json$Decode.list(rangeDecoder);
      var matchDecoder = A3($Json$Decode.object2,
      F2(function (name,ranges) {
         return {_: {}
                ,boldRanges: ranges
                ,item: name};
      }),
   ...
   var myStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                     ...
                                                     ,{ctor: "_Tuple2"
                                                      ,_0: "text-align"
                                                      ,_1: "center"}]));
   var listItem2Style = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                             ,_0: "display"
                                                             ,_1: "block"}
                                                            ,{ctor: "_Tuple2"
                                                             ,_0: "padding"
                                                            ...
                                                            ,{ctor: "_Tuple2"
                                                             ,_0: "cursor"
                                                             ,_1: "pointer"}]));
   var listItemStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                            ,_0: "display"
                                                            ,_1: "block"}
                                                           ,{ctor: "_Tuple2"
                                                            ,_0: "padding"
                                                           ...
                                                           ,{ctor: "_Tuple2"
                                                            ,_0: "cursor"
                                                            ,_1: "pointer"}]));
   var listStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                        ,_0: "position"
                                                        ,_1: "absolute"}
                                                       ,{ctor: "_Tuple2"
                                                        ,_0: "background"
                                                       ...
                                                       ,{ctor: "_Tuple2"
                                                        ,_0: "width"
                                                        ,_1: "400px"}]));
   var displayBlockStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                ,_0: "display"
                                                                ,_1: "block"}]));
   var stringInput = function (string) {
      ...
      _L.fromArray([$Html$Attributes.placeholder("Text to reverse")
                   ...
                   $Signal.send(searchbox))
                   ,myStyle]),
      _L.fromArray([]));
   };
   var boldedTextHelper = F3(function (string,
   boldRanges,
   currentIndex) {
      return function () {
         switch (boldRanges.ctor)
         {case "::":
            switch (boldRanges._0.ctor)
              {case "_Tuple2":
                 return _U.cmp(currentIndex,
                   boldRanges._0._0) < 0 ? function () {
                      var rest = A3(boldedTextHelper,
                      string,
                      boldRanges,
                      boldRanges._0._0);
                      var nonbold = $Html.text(A3($String.slice,
                      currentIndex,
                      boldRanges._0._0,
                      string));
                      return A2($List._op["::"],
                      ...
                      boldRanges._1,
                      boldRanges._0._1 + 1);
                      var slice = A3($String.slice,
                      boldRanges._0._0,
                      boldRanges._0._1 + 1,
                      string);
                      var bold = A2($Html.strong,
                      _L.fromArray([]),
                      _L.fromArray([$Html.text(slice)]));
                      return A2($List._op["::"],
                      bold,
                      rest);
                   }();}
              break;
            case "[]":
            return _U.eq(currentIndex,
              $String.length(string)) ? _L.fromArray([]) : _L.fromArray([$Html.text(A2($String.dropLeft,
              currentIndex,
              string))]);}
         _U.badCase($moduleName,
         "between lines 63 and 80");
      }();
   });
   var boldedText = F2(function (string,
   boldRanges) {
      return A2($Html.span,
      _L.fromArray([]),
      A3(boldedTextHelper,
   ...
   var boldedItems = function (match) {
      return function () {
         var boldedItem = function (item) {
            return function () {
               var relativeLink = A2($Basics._op["++"],
               match.moduleName,
               A2($Basics._op["++"],
               "#",
               item.item));
               return A2($Html.a,
               _L.fromArray([$Html$Attributes.href(relativeLink)
                            ,displayBlockStyle]),
               _L.fromArray([A2(boldedText,
               item.item,
               item.boldRanges)]));
            }();
         };
         ...
         function (match) {
            return A2($Html.li,
            _L.fromArray([listItem2Style]),
            _L.fromArray([boldedItem(match)]));
         },
         match.matches);
      }();
   };
   var searchResult = F2(function (query,
   match) {
      return function () {
         var rest = boldedItems(match);
         var mainText = A2($Html.a,
         _L.fromArray([$Html$Attributes.href(match.moduleName)
                      ,displayBlockStyle]),
         _L.fromArray([A2(boldedText,
         match.moduleName,
         match.boldRanges)]));
         var main = A2($Html.li,
         _L.fromArray([listItemStyle]),
         _L.fromArray([mainText]));
         return A2($List._op["::"],
         main,
         rest);
      }();
   });
   var searchResults = F2(function (query,
   matches) {
      return A2($Html.ul,
      _L.fromArray([listStyle]),
      $List.concat($List.map(searchResult(query))(matches)));
   });
   var search = function (query) {
      return _L.fromArray([{_: {}
                           ,boldRanges: _L.fromArray([])
                           ,matches: _L.fromArray([{_: {}
                                                   ,boldRanges: _L.fromArray([{ctor: "_Tuple2"
                                                                              ,_0: 0
                                                                              ,_1: 0}
                                                                             ,{ctor: "_Tuple2"
                                                                              ,_0: 2
   ...
   var parseResults = function (response) {
      return function () {
         ...
         {case "Failure":
            return $Maybe.Just(_L.fromArray([{_: {}
                                             ,boldRanges: _L.fromArray([])
                                             ,matches: _L.fromArray([])
                                             ,moduleName: A2($Basics._op["++"],
                                             "Failure: ",
                                             response._1)}]));
            case "Success":
            return $Maybe.Just(search(""));
            case "Waiting":
            return $Maybe.Just(_L.fromArray([{_: {}
                                             ,boldRanges: _L.fromArray([])
                                             ,matches: _L.fromArray([])
      ...
      return function () {
         ...
         {case "SearchBoxNone":
            ...
            return _U.replace([["query"
                               ,event._0]],
              state);
            case "SearchResultArrived":
            return _U.replace([["results"
                               ,parseResults(event._0)]],
              state);}
         _U.badCase($moduleName,
   ...
   var scene = function (state) {
      return function () {
         var dropdown = function () {
            var _v12 = state.results;
            switch (_v12.ctor)
            {case "Just":
               return _L.fromArray([A2(searchResults,
                 state.query,
                 _v12._0)]);
               case "Nothing":
               return _L.fromArray([]);}
         ...
         _L.fromArray([]),
         A2($Basics._op["++"],
         _L.fromArray([$Html.text(state.query)
                      ,stringInput(state.query)]),
         dropdown)));
      }();
   };
   var searchRequest = function (query) {
      return $String.isEmpty(query) ? $Http.get("") : $Http.get(A2($Basics._op["++"],
      "http://rudichen.me:9000/search/elm-lang-Elm/",
      A2($Basics._op["++"],
      query,
      "?version=0.13")));
   };
   var ModuleMatch = F3(function (a,
   b,
   c) {
      return {_: {}
             ,boldRanges: b
   ...
   var ItemMatch = F2(function (a,
   b) {
      return {_: {}
             ,boldRanges: b
             ,item: a};
   });
   var SearchResultArrived = function (a) {
      return {ctor: "SearchResultArrived"
             ,_0: a};
   };
   var SearchBoxTyped = function (a) {
      return {ctor: "SearchBoxTyped"
             ,_0: a};
   };
   var SearchBoxNone = {ctor: "SearchBoxNone"};
   var main = function () {
      var responses = $Http.send(A2($Signal._op["<~"],
      searchRequest,
      searchSignal));
      var events = $Signal.mergeMany(_L.fromArray([$Signal.constant(SearchBoxNone)
                                                  ,A2($Signal._op["<~"],
                                                  SearchBoxTyped,
                                                  searchSignal)
                                                  ,A2($Signal._op["<~"],
   ...
   _elm.Searchbox.values = {_op: _op
                           ,SearchBoxNone: SearchBoxNone
                           ,SearchBoxTyped: SearchBoxTyped
                           ,SearchResultArrived: SearchResultArrived
                           ,ItemMatch: ItemMatch
                           ,ModuleMatch: ModuleMatch
                           ,searchRequest: searchRequest
                           ,scene: scene
                           ,search: search
                           ,boldedTextHelper: boldedTextHelper
                           ,boldedText: boldedText
                           ,boldedItems: boldedItems
                           ,searchResult: searchResult
                           ,searchResults: searchResults
                           ,stringInput: stringInput
                           ,displayBlockStyle: displayBlockStyle
                           ,listStyle: listStyle
                           ,listItemStyle: listItemStyle
                           ,listItem2Style: listItem2Style
                           ,myStyle: myStyle
